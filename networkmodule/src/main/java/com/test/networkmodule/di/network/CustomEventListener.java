 ...
 */
public final class CustomEventListener extends EventListener {
    private final HttpLoggingInterceptor.Logger logger;
    private long startNs;

    public CustomEventListener(HttpLoggingInterceptor.Logger logger) {
        this.logger = logger;
    }
    ...
    public void connectionAcquired(Call call, Connection connection) {
        logWithTime("connectionAcquired: " + "Connection Id: " + System.identityHashCode(connection) + " Connection Info: " + connection);
    }
    ...
    public static class Factory implements EventListener.Factory {
        ...
        public EventListener create(Call call) {
            return new CustomEventListener(logger);
        }
    }
}
